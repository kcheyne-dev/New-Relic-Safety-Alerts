...
export function bootDemoMode() {
  if (!API_BASE && /[#&]api=mock/.test(location.hash)) {
    (function bootDemoModeInner() {
      ...
      const POOL = [
        // ── San Francisco ──
        { sev:'high', type:'Public Safety', source:'sf_police',  officeId:'SFO',
        ...
        { sev:'mod',  type:'Natural Disaster', source:'eonet', officeId:'SFO',
        ...
        // ── Portland ──
        { sev:'mod',  type:'Public Safety', source:'pdx_flashalert', officeId:'PDX',
        ...
        { sev:'high', type:'Public Safety', source:'london_tfl',      officeId:'LON',
        ...
        { sev:'mod',  type:'Travel Advisory', source:'state_dept', officeId:null,
        ...
        { sev:'low',  type:'Travel Advisory', source:'state_dept', officeId:null,
